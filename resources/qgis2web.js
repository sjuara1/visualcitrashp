...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32649',
            extent: [424485.000000, -790065.000000, 432375.000000, -766605.000000],
            units: 'm'})
    })
});
...
map.getView().fit([424485.000000, -790065.000000, 432375.000000, -766605.000000], map.getSize());
